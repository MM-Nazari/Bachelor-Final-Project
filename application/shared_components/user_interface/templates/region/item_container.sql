...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793717003834812349)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793717304846812349)
,p_plug_template_id=>wwv_flow_imp.id(26793717003834812349)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793717618677812350)
,p_plug_template_id=>wwv_flow_imp.id(26793717003834812349)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793717910502812350)
,p_plug_template_id=>wwv_flow_imp.id(26793717003834812349)
,p_name=>'Button Start'
