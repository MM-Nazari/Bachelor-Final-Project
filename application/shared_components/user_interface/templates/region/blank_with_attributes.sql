...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793658015504812324)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793658340649812324)
,p_plug_template_id=>wwv_flow_imp.id(26793658015504812324)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793658629037812324)
,p_plug_template_id=>wwv_flow_imp.id(26793658015504812324)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793658948351812324)
,p_plug_template_id=>wwv_flow_imp.id(26793658015504812324)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793659226513812325)
,p_plug_template_id=>wwv_flow_imp.id(26793658015504812324)
,p_name=>'Sub Regions'
