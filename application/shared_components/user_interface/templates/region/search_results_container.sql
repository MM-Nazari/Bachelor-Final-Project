...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793722066078812352)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793722319229812352)
,p_plug_template_id=>wwv_flow_imp.id(26793722066078812352)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793722642567812352)
,p_plug_template_id=>wwv_flow_imp.id(26793722066078812352)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793722938206812352)
,p_plug_template_id=>wwv_flow_imp.id(26793722066078812352)
,p_name=>'Sub Regions'
