...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793742306035812361)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793742661712812361)
,p_plug_template_id=>wwv_flow_imp.id(26793742306035812361)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793742904636812361)
,p_plug_template_id=>wwv_flow_imp.id(26793742306035812361)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793743211427812361)
,p_plug_template_id=>wwv_flow_imp.id(26793742306035812361)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793743536802812361)
,p_plug_template_id=>wwv_flow_imp.id(26793742306035812361)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793743885398812361)
,p_plug_template_id=>wwv_flow_imp.id(26793742306035812361)
