...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793691307370812338)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793691621124812339)
,p_plug_template_id=>wwv_flow_imp.id(26793691307370812338)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793691912617812339)
,p_plug_template_id=>wwv_flow_imp.id(26793691307370812338)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793692247225812339)
,p_plug_template_id=>wwv_flow_imp.id(26793691307370812338)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793692519526812339)
,p_plug_template_id=>wwv_flow_imp.id(26793691307370812338)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793692822338812339)
,p_plug_template_id=>wwv_flow_imp.id(26793691307370812338)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
