...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793694860530812340)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793695122983812340)
,p_plug_template_id=>wwv_flow_imp.id(26793694860530812340)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793695454712812340)
,p_plug_template_id=>wwv_flow_imp.id(26793694860530812340)
,p_name=>'Sub Regions'
