...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793714942454812348)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793715235495812349)
,p_plug_template_id=>wwv_flow_imp.id(26793714942454812348)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793715555503812349)
,p_plug_template_id=>wwv_flow_imp.id(26793714942454812348)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793715845259812349)
,p_plug_template_id=>wwv_flow_imp.id(26793714942454812348)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793716143578812349)
,p_plug_template_id=>wwv_flow_imp.id(26793714942454812348)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793716433966812349)
,p_plug_template_id=>wwv_flow_imp.id(26793714942454812348)
,p_name=>'Sub Regions'
