...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793686733866812336)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793687006811812336)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793687325371812336)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793687633819812337)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793687929872812337)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793688271710812337)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793688586587812337)
,p_plug_template_id=>wwv_flow_imp.id(26793686733866812336)
,p_name=>'Sub Regions'
