...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793659495716812325)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793659793461812325)
,p_plug_template_id=>wwv_flow_imp.id(26793659495716812325)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793660021864812325)
,p_plug_template_id=>wwv_flow_imp.id(26793659495716812325)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793660360995812325)
,p_plug_template_id=>wwv_flow_imp.id(26793659495716812325)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793660669678812325)
,p_plug_template_id=>wwv_flow_imp.id(26793659495716812325)
,p_name=>'Sub Regions'
