...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793665146362812327)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793665413228812327)
,p_plug_template_id=>wwv_flow_imp.id(26793665146362812327)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793665701489812327)
,p_plug_template_id=>wwv_flow_imp.id(26793665146362812327)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793666087578812328)
,p_plug_template_id=>wwv_flow_imp.id(26793665146362812327)
,p_name=>'Sub Regions'
