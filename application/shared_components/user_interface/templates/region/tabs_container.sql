...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793734557781812357)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793734898089812358)
,p_plug_template_id=>wwv_flow_imp.id(26793734557781812357)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793735103085812358)
,p_plug_template_id=>wwv_flow_imp.id(26793734557781812357)
,p_name=>'Tabs'
