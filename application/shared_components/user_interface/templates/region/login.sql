...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(26793719581656812350)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793719899725812351)
,p_plug_template_id=>wwv_flow_imp.id(26793719581656812350)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793720188792812351)
,p_plug_template_id=>wwv_flow_imp.id(26793719581656812350)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793720421318812351)
,p_plug_template_id=>wwv_flow_imp.id(26793719581656812350)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793720778605812351)
,p_plug_template_id=>wwv_flow_imp.id(26793719581656812350)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793721083028812351)
,p_plug_template_id=>wwv_flow_imp.id(26793719581656812350)
,p_name=>'Sub Regions'
