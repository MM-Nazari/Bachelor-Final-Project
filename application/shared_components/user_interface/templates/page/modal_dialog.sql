...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(26793642717617812317)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793643067429812317)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793643300249812317)
,p_page_template_id=>wwv_flow_imp.id(26793642717617812317)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793643600209812317)
,p_page_template_id=>wwv_flow_imp.id(26793642717617812317)
