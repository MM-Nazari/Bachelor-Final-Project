...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(26793651330286812321)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793651680019812321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793651963485812321)
,p_page_template_id=>wwv_flow_imp.id(26793651330286812321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793652223047812321)
,p_page_template_id=>wwv_flow_imp.id(26793651330286812321)
