...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(26793622126224812307)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793622457186812307)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793622744643812307)
,p_page_template_id=>wwv_flow_imp.id(26793622126224812307)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793623025855812307)
,p_page_template_id=>wwv_flow_imp.id(26793622126224812307)
