...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(26793632768885812312)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793633051639812312)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793633373627812312)
,p_page_template_id=>wwv_flow_imp.id(26793632768885812312)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793633649836812313)
,p_page_template_id=>wwv_flow_imp.id(26793632768885812312)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(26793633977458812313)
,p_page_template_id=>wwv_flow_imp.id(26793632768885812312)
,p_name=>'Body Footer'
